...
Bullseye does not require an account and does not ask you for personal information. To
provide its features, the app may use the following device capabilities, all processed
...
The app does not access your contacts, microphone, or your photo library at large.

## Data stored on your device

Your profiles, shot logs, measured groups, settings, and sensor readings are stored
locally on your device only. Target photographs used by the Group Analyzer are stored in
the app's private storage, which other apps cannot read. This information is not
uploaded to us or to any external service. Uninstalling the app removes this data.
